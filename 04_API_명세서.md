# 📖 QT-AI (큐티 AI 앱) — API 명세서 v1.7

> **문서 버전:** v1.7
> **작성일:** 2026-05-06 (v1.0) / 2026-05-06 (v1.1) / 2026-05-07 (v1.2) / 2026-05-09 (v1.3 — yaml 이슈 6종 패치) / 2026-05-09 (v1.4 — yaml↔명세서 정합) / 2026-05-09 (v1.5 — DECISIONS.md 정합 + journal yaml 재작성) / 2026-05-12 (v1.6 — Journal API 폐기 + Bible Service 통합) / 2026-05-13 (v1.7 — 오전 회의 MVP 범위 반영)
> **연관 문서:** [01_프로젝트_계획서 v1.4](./01_프로젝트_계획서.md) / [02_ERD_문서 v1.6](./02_ERD_문서.md) / [03_아키텍처_정의서 v1.3](./03_아키텍처_정의서.md) / [24_회의결정_2026-05-13_오전](./24_회의결정_2026-05-13_오전.md)
> **W1 Lock-in 산출물:** 본 문서 + `apis/{service}/openapi.yaml` × 4 (Spectral lint 통과 + Prism mock 가동) — 03번 § 2.2

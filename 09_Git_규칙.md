...
아래 기준은 이 문서 전체에 우선한다. 기능·비기능·화면 요구사항이 충돌하면 `07_요구사항_정의서.md` v2.3을 따른다. 문서 역할과 충돌 처리 방식은 `00_문서_역할_분리표.md`를 따른다.
...
| v2.3 | 2026-05-14 | Codex + 강태오 | `07_요구사항_정의서.md` v2.3 기준으로 Modular Monolith, 배치 AI, API prefix, 금지 패턴, PR 체크리스트 정합화 |
...
| Git 규칙 문서 | 이 문서에서 v2.4로 재점검 완료 |
| 문서 역할 분리표 | `00_문서_역할_분리표.md` v0.1 반영 |
| ERD 문서 | `02_ERD_문서.md` v0.1 반영 |
| 구현 저장소 반영 체크리스트 | `22_구현_저장소_반영_체크리스트.md` v0.1 반영 |
| 기능 명세서 | `25_기능_명세서.md` v0.1 반영 |
| 화면 기능 정의서 | `06_화면_기능_정의서.md` v0.1 반영 |
| 시퀀스 다이어그램 | `05_시퀀스_다이어그램.md` v0.1 반영 |
...
> **Git 규칙의 핵심:** 자동 리뷰가 있더라도 PR 템플릿을 성실하게 작성해야 팀 전체 시간이 줄어든다. v2.3 요구사항과 충돌하는 구현은 "임시"라도 머지하지 않는다.
